            ...
            <IonContent fullscreen className='page-background'>
                <IonGrid className='p-3'>
                    ...
                    <IonCard className='shadow-sm p-4 py-5 rounded-5 m-3 mt-4'>
                        <IonRow className='d-flex justify-content-center fs-5 fw-bold'>Quên mật khẩu</IonRow>
                        ...
                        <IonRow className='mt-4'>
                            <button className='bg-pink rounded-pill p-3 w-100 fs-13 text-white'>Quên mật khẩu</button>
                        </IonRow>
                        <IonRow className='d-flex justify-content-between align-items-center mt-3'>
                            <div className='fs-13'>
                               Bạn đã có tài khoản?
                            </div>
                            <Link to="/login" className="text-decoration-none fs-13 fw-bold">Đăng nhập</Link>
                        </IonRow>
                    </IonCard>
                </IonGrid>
